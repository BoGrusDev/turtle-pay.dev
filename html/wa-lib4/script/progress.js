...
Progress.start = function() {
    var param = {};
    param._action = "Progress";
    param._log_id = LOG_ID;
...
message['klart'] += 'Om du inte fått fakturan inom några minuter kan du kontrollera din skräppost eller kontakta Turtle Pay AB på info@turtle-pay.com eller tel. 08-806220.';

message['not-in-progress'] = "<strong>INGET FAKTURAKÖP PÅGÅR FÖR TILLFÄLLET!</strong><br/>" + messageTurtle; 
message['not'] = "<strong>FAKTURAKÖPET GICK INTE ATT GENOMFÖRA!</strong><br/>" + messageTurtle;
